...
public class AddExpensePanel extends JPanel {
    ...
    String buildBudgetAlertMessage(String category, double totalSpent, double limit) {
        return buildBudgetAlertMessage(totalSpent, limit, "$" );
    }

    String buildBudgetAlertMessage(String category, double totalSpent, double limit, String currency) {
        return buildBudgetAlertMessage(totalSpent, limit, getCurrencySymbol(currency));
    }

    private String buildBudgetAlertMessage(double totalSpent, double limit, String currencySymbol) {
