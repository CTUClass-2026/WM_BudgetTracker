...
public class ExpenseService {
    ...
    // Public method for adding an expense
    ...
    // Public method for deleting an expense
    public void deleteExpense(int id) throws IOException {
        expenseDAO.delete(id);
    }

    // Public method for listing all the expenses
    public List<Expense> getAllExpenses() throws IOException {
        return expenseDAO.findAll();
    }

    // Public method for listing expenses by month and year
